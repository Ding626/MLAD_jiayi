...
namespace planning {
class SscPlannerServer { // Tips:  SPATIO-TEMPORAL SEMANTIC CORRIDOR 即轨迹生成部分，应该放在agv上，可以删除
 public:
  using SemanticMapManager = semantic_map_manager::EgoSemanticMapManager;
  ...
  SscPlannerServer(ros::NodeHandle nh, double work_rate, int ego_id, bool use_sim_state);
 ...
 private:
  ...
  ros::Publisher executing_traj_update_pub_;
