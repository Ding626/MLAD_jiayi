...
Vehicle::Vehicle(const int &id, const VehicleParam &param, const State &state, 
                 const bool &ready_change_lane)
    : id_(id), param_(param), state_(state), ready_change_lane_(ready_change_lane) {}
...
Vehicle::Vehicle(const int &id, const std::string &subclass,
                 const VehicleParam &param, const State &state, std::string &name, 
                 const bool &ready_change_lane)
    : id_(id), subclass_(subclass), param_(param), state_(state), name_(name), ready_change_lane_(ready_change_lane) {}

Vehicle::Vehicle(const int &id, const std::string &subclass,
                 const VehicleParam &param, const State &state, std::string &name, 
                 const bool &ready_change_lane, const std::string &type)
    : id_(id), subclass_(subclass), param_(param), state_(state), name_(name), ready_change_lane_(ready_change_lane), type_(type) {}
