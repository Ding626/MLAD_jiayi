...
void Visualizer::VisualizeData(const EgoSemanticMapManager &smm) {
...
void Visualizer::VisualizeDataWithStamp(const ros::Time &stamp,
                                        const EgoSemanticMapManager &smm) {
...
void Visualizer::VisualizeDataWithStampForPlayback(
    const ros::Time &stamp, const EgoSemanticMapManager &smm,
...
void Visualizer::VisualizeLocalLanes(
    ...
    const EgoSemanticMapManager &smm, const std::vector<int> &deleted_lane_ids) {
