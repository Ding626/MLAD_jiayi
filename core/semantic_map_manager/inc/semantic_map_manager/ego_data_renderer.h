#ifndef _CORE_SEMANTIC_MAP_INC_SEMANTIC_MAP_MANAGER_EGO_DATA_RENDERER_H_
#define _CORE_SEMANTIC_MAP_INC_SEMANTIC_MAP_MANAGER_EGO_DATA_RENDERER_H_
...
class EgoDataRenderer {
 public:
  ...
  ErrorType Render(const double &time_stamp, 
 ...
 private:
  ...
  EgoSemanticMapManager *p_semantic_map_manager_;
